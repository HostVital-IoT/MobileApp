            ...
            <ScrollView style={styles.container}>
                <View style={styles.content}>
                    ...
                    <View style={styles.form}>
                        ...
                        />
                        <Text style={styles.inputText}>Blood Pressure</Text>
                        <TextInput
                            style={styles.input}
                            placeholder={`${badge.blood_pressure}`}
                            onChangeText={text => {
                                this.setState(prevState => {
                                    let form = Object.assign({}, prevState.form);
                                    form.life = text;
                        ...
                        />
                        <Text style={styles.inputText}>Sugar Level</Text>
                        <TextInput
                            style={styles.input}
                            placeholder={`${badge.sugar_level}`}
                            onChangeText={text => {
                                this.setState(prevState => {
                                    let form = Object.assign({}, prevState.form);
                                    form.magic = text;
                        ...
                        />
                        <Text style={styles.inputText}>Oxygen Level</Text>
                        <TextInput
                            style={styles.input}
                            placeholder={`${badge.oxygen_level}`}
                            onChangeText={text => {
                                this.setState(prevState => {
                                    let form = Object.assign({}, prevState.form);
                                    form.strenght = text;
